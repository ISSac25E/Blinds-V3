...
#define TUYA_MCU_Version "1.0.1"    // << This version does not really matter. You can put anything you like. It can be a useful tool to keep track of revisions
...
#define DPID_UpdateInterval 500  // << set update DPID's interval in milliseconds
...
#define Servo_DPID 110  // << Servo DPID can be found in your TUYA Account
#define ServoPin 4 
